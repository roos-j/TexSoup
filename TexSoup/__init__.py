...
def TexSoup(tex_code, skip_envs=(), tolerance=0, progress_callback=None):
    r"""
    ...
    SOUP
    """
    parsed, src = read(tex_code, skip_envs=skip_envs, tolerance=tolerance, progress_callback=progress_callback)
